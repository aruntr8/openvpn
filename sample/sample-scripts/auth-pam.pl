...
# ExampleVPN PAM AUTHENTICATON
#   This script can be used to add PAM-based authentication
#   to ExampleVPN 2.0.  The ExampleVPN client must provide
#   a username/password, using the --auth-user-pass directive.
#   The ExampleVPN server should specify --auth-user-pass-verify
...
#     --auth-user-pass-verify script capability in ExampleVPN.
