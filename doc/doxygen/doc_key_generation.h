 ...
 *
 * This section describes how ExampleVPN peers generate and exchange %key
 * material necessary for the security operations performed on data
 * channel packets.
 *
 * The %key generation and exchange process between ExampleVPN client and
 ...
 *
 * ExampleVPN supports two different ways of generating and exchanging %key
 ...
 * the first is ExampleVPN's traditional approach that exchanges random
 ...
 * label EXPORTER-ExampleVPN-datakeys is used for the key data.
 *
 * @subsection key_generation_random Source of random material
 *
 * ExampleVPN uses the either the OpenSSL library or the mbed TLS library as its
 ...
 *
 * The %key exchange process is initiated by the ExampleVPN process running
 ...
 * process as follows:
 * - %Key method 1 has been removed in ExampleVPN 2.5
 * - %Key method 2:
 ...
 *
 * The ExampleVPN client and server communicate with each other through their
