 ...
 * data channel large packet to be sent to a remote ExampleVPN peer can be
 ...
 * - For packets which will be sent to a remote ExampleVPN peer: \c
 *   fragment_outgoing() \n This function inspects data channel packets as
 *   they are being made ready to be sent as VPN tunnel packets to a
 *   remote ExampleVPN peer.  If a packet's size is larger than its
 ...
 * - For packets which have been received from a remote ExampleVPN peer: \c
 *   fragment_incoming() \n This function inspects data channel packets
 *   that have been received from a remote ExampleVPN peer through a VPN
