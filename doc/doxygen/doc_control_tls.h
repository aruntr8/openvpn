 ...
 * exchanged between ExampleVPN peers.
 *
 ...
 * local ExampleVPN process and a remote peer.  This protocol simultaneously
 ...
 * ExampleVPN-based system.  On the one hand, it performs the security
 * operations necessary to protect control channel messages exchanged
 * between ExampleVPN peers.  On the other hand, before the control and data
 ...
 * plaintext I/O port. Its interaction with ExampleVPN's control channel
