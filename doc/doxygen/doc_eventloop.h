 ...
 *
 * This main event loop module drives the packet processing of ExampleVPN.
 *
 * ExampleVPN is an event driven system.  Its activities are driven by a main
 ...
 * The major types of network events that ExampleVPN processes are:
 ...
 *
 * Beside these external events, ExampleVPN also processes other types of
 ...
 *
 * Depending on the mode in which ExampleVPN is running, a different main
