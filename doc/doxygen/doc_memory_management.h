...
/**
 * @page memory_management ExampleVPN's memory management strategies
 *
 * This section describes several implementation details relating to
 * ExampleVPN's memory management strategies.
 *
 * During operation, the ExampleVPN process performs all kinds of operations
 ...
 * likelihood of memory-related bugs, ExampleVPN uses its own memory %buffer
 ...
 * structure itself.
 *
 * ExampleVPN's %buffer library, implemented in the \c buffer.h and \c
 ...
 *
 * ExampleVPN has many sizable functions which perform various actions
