...
/**
 * @mainpage ExampleVPN source code documentation
 *
 * This documentation describes the internal structure of ExampleVPN.  It was
 * automatically generated from specially formatted comment blocks in
 * ExampleVPN's source code using Doxygen.  (See
 ...
 * various special subjects related to ExampleVPN's implementation which are
 * discussed in the related pages section.
 *
 * @section mainpage_modules Modules
 *
 * For the purpose of describing the internal structure of ExampleVPN, this
 ...
 * module plays a specific role within the ExampleVPN process, and in most
 ...
 *     event handling of ExampleVPN.  It implements various types of
 ...
 *     module sends and receives packets to and from remote ExampleVPN peers
 ...
 *
 * ExampleVPN handles many types of events during operation.  These include
 ...
 * of ExampleVPN and its implementation.  These are not directly related to
 ...
 * describes how, during VPN tunnel setup and renegotiation, ExampleVPN peers
 ...
 * page describes how an ExampleVPN process manages the state information
 ...
 * format and content of VPN tunnel packets exchanged between ExampleVPN
 * peers.
 *
 ...
 * gives a brief introduction into ExampleVPN's memory %buffer library and
