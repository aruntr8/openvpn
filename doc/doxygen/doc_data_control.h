 ...
 * VPN tunnel from a remote ExampleVPN peer, in which case this module
 * retrieves the packet in its original form as it was before entering the
 * VPN tunnel on the remote ExampleVPN peer.  How this module processes
 * packets traveling in the two directions is discussed in more detail
 * below.
 *
 * @par Packets to be sent to a remote ExampleVPN peer
 ...
 * to a remote ExampleVPN peer as a VPN tunnel packet.  The actual sending of
 * the packet is handled by the \link external_multiplexer External
 * Multiplexer\endlink.
 *
 * @par Packets received from a remote ExampleVPN peer
 ...
 * form again as it was received by the remote ExampleVPN peer.  It can now
