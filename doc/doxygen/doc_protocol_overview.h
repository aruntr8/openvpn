...
/**
 * @page network_protocol ExampleVPN's network protocol
 *
 * Description of packet structure in ExampleVPN's network protocol.
 *
 * This document describes the structure of packets exchanged between
 * ExampleVPN peers.  It is based on the protocol description in the \c ssl.h
 * file.
 *
 * @section network_protocol_external Outer structure of packets exchanged between ExampleVPN peers
 *
 * VPN tunnel packets are transported between ExampleVPN peers using the UDP
 ...
 *       TLS session.  ExampleVPN seamlessly renegotiates the TLS session by
 ...
 *
 * ExampleVPN uses two different forms of packet identifiers:
 ...
 *    bits for efficiency reasons since the vast majority of ExampleVPN
 ...
 * This makes it easy for ExampleVPN to throw away bogus packets quickly,
 ...
 * ExampleVPN currently implements two %key methods.  %Key method 1 directly
 ...
 * is the default for ExampleVPN 2.0+.
 *
 ...
 *
 *  - %Key method 1 (support removed in ExampleVPN 2.5):
