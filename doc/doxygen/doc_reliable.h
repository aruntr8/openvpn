 ...
 *
 * The Reliability Layer is part of ExampleVPN's control channel.  It
 * provides a reliable and sequential transport mechanism for control
 * channel messages between ExampleVPN peers.  This module forms the
 ...
 *
 * This is especially important when ExampleVPN is configured to communicate
 * over UDP, because UDP does not offer a reliable and sequential
 * transport.  ExampleVPN endpoints can also communicate over TCP which does
