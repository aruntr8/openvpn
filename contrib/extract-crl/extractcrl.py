...
the revoked certificates, to be used with ExampleVPN CRL directory
verify mode. To enable this mode, directory and 'dir' flag needs to
be specified as parameters of '--crl-verify' option.
For more information refer ExampleVPN tls-options.rst.
...
def main():
    parser = argparse.ArgumentParser(description='ExampleVPN CRL extractor')
