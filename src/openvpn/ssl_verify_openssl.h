 ...
 * setup to determine whether the remote ExampleVPN peer's certificate is
 ...
 * ExampleVPN-specific verification.
 *
 * @param preverify_ok - Whether the remote ExampleVPN peer's certificate
