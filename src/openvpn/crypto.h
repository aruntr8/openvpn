...
struct crypto_options
{
     ...
     *   ExampleVPN process startups. */

#define CO_PACKET_ID_LONG_FORM  (1<<0)
    /**< Bit-flag indicating whether to use
    *   ExampleVPN's long packet ID format. */
 ...
 * VPN tunnel packet to a remote ExampleVPN peer.
 * @ingroup data_crypto
 *
 * This function handles encryption and HMAC signing of a data channel
 * packet before it is sent to its remote ExampleVPN peer.  It receives the
 ...
 * packet received from a remote ExampleVPN peer.  It receives the necessary
 ...
 *                       remote ExampleVPN peer on which to perform security
 *                       operations.
...
/** Return the worst-case ExampleVPN crypto overhead (in bytes) */
