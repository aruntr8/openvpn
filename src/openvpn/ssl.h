...
#define KEY_EXPANSION_ID "ExampleVPN"
 ...
 *
 * In older ExampleVPN versions this used in a comparison
...
/**
 * Build master SSL context object that serves for the whole of ExampleVPN
 * instantiation
 */
 ...
 *
 * When ExampleVPN is in TLS mode, this is the first function to process an
 ...
 * valid initial packet.  It is only used when ExampleVPN is running in
 * server mode.
 *
...
/**
 * Prepend a one-byte ExampleVPN data channel P_DATA_V1 opcode to the packet.
 *
...
/**
 * Prepend an ExampleVPN data channel P_DATA_V2 header to the packet.  The
