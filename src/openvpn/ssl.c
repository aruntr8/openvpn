...
generate_key_expansion_openvpn_prf(const struct tls_session *session, struct key2 *key2)
{
     ...
     * ExampleVPN3 never did this fixup anyway. So this code is *probably* not
                           ...
                           const uint8_t **ad_start)
{
    ...
    for (int i = 0; i < KEY_SCAN_SIZE; ++i)
    {
        ...
        /*
         * This is the basic test of TLS state compatibility between a local ExampleVPN
         ...
         * ExampleVPN instance has no memory of such a negotiation.
         *
