 ...
 * tunnel.
 *
 * The fragmented packet currently being sent to a remote ExampleVPN peer is
...
#define N_SEQ_ID            256
    ...
    int outgoing_seq_id;        /**< Fragment sequence ID of the current
                                 ...
                                 *   the remote ExampleVPN peer can determine
...
/**************************************************************************/
/** @name Functions for processing packets received from a remote ExampleVPN peer */
/** @{ */
...
/**************************************************************************/
/** @name Functions for processing packets to be sent to a remote ExampleVPN peer */
/** @{ */
