...
/**************************************************************************/
/**
 * Level 0 %context containing information related to the ExampleVPN process.
 *
 * Level 0 state is initialized once at program startup, and then remains
 * throughout the lifetime of the ExampleVPN process.  This structure
...
struct context_1
{
     ...
     *   remote ExampleVPN server.  Only used in
     *   client-mode. */
...
struct context_2
{
    ...
    /* Timer for everything up to the first packet from the *ExampleVPN* server
...
#define CM_CHILD_TCP      4  /* child context of a CM_TOP or CM_THREAD */
    int mode;                   /**< Role of this context within the
                                 *   ExampleVPN process.  Valid values are \c
