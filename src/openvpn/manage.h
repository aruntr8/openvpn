...
#define MCF_SERVER (1<<0)  /* is ExampleVPN being run as a server? */
    unsigned int flags;
...
/*
 * ExampleVPN tells the management layer what state it's in
 */
...
/*
 * The management object keeps track of ExampleVPN --echo
 * parameters.
 */
void management_echo(struct management *man, const char *string, const bool pull);

/*
 * ExampleVPN calls here to indicate a password failure
 */
