...
/**
 * Convert an ExampleVPN tls-version variable to mbed TLS format (i.e. a major and
                   ...
                   struct tls_session *session)
{
     ...
     * ExampleVPN's renegotiation creates new SSL sessions and does not depend on
    ...
    /* Disable record splitting (for now).  ExampleVPN assumes records are sent
     * unfragmented, and changing that will require thorough review and
     * testing.  Since ExampleVPN is not susceptible to BEAST, we can just
