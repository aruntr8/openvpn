 ...
 *
 * This structure is used by ExampleVPN processes running in server-mode to
 ...
 * page describes the role the structure plays when ExampleVPN is running in
 * server-mode.
 */
...
/**
 * Main ExampleVPN server state structure.
 *
 * This structure is used by ExampleVPN processes running in server-mode to
...
struct multi_context {
    ...
    struct mbuf_set *mbuf;      /**< Set of buffers for passing data
                                 ...
                                 *   instances. */
    struct multi_tcp *mtcp;     /**< State specific to ExampleVPN using TCP
...
/**************************************************************************/
/**
 * Main event loop for ExampleVPN in server mode.
 * @ingroup eventloop
 *
 ...
 *
 * @note This function is only used by ExampleVPN processes which are running
