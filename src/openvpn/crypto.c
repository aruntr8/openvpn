                        ...
                        const char *key_name, const char *opt_name)
{
    ...
    if (key2.n != 2)
    {
        msg(M_ERR, "File '%s' does not have ExampleVPN Static Key format.  Using "
...
static const char static_key_head[] = "-----BEGIN ExampleVPN Static key V1-----";
static const char static_key_foot[] = "-----END ExampleVPN Static key V1-----";
