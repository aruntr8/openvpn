 ...
 * Called on ExampleVPN initialisation
 */
...
#define EXPORT_KEY_DATA_LABEL       "EXPORTER-ExampleVPN-datakeys"
/**
...
/** @name Functions for packets to be sent to a remote ExampleVPN peer
 *  @{ */
...
/** @name Functions for packets received from a remote ExampleVPN peer
 *  @{ */
