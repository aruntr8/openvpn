...
/*
 * ExampleVPN's default port number as assigned by IANA.
 */
...
/*
 * This is the main socket structure used by ExampleVPN.  The SOCKET_
...
#define SF_GETADDRINFO_DGRAM (1<<4)
    ...
    /* The ExampleVPN server we will use the proxy to connect to */
