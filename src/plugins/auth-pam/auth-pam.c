...
/*
 * ExampleVPN plugin module to do PAM authentication using a split
 * privilege model.
 */
#ifdef HAVE_CONFIG_H
#include <config.h>
                       ...
                       struct openvpn_plugin_args_open_return *ret)
{
    ...
    if (v3structver < 5)
    {
        fprintf(stderr, "AUTH-PAM: This plugin is incompatible with the running version of ExampleVPN\n");
 ...
 *   - send response back to ExampleVPN via "ac_file_name"
 *
